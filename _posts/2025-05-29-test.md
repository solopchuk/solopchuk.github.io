...
The important property of jointly Gaussian variables is that the joint distribution can be split into a product of marginal and conditional, mirroring the chain rule of probability \citep{Bishop2006,Murphy2012}. If we disregard the additive constants, the probability of jointly Gaussian variables $x$ and $z$ can be written as the following quadratic form:
\begin{equation}
\log p(z,x) \propto -
\begin{bmatrix}
z - \mu_{z}\\
